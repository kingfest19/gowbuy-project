...
class ProductFilter(django_filters.FilterSet):
    ...
    origin_country = django_filters.ChoiceFilter(choices=countries, field_name='origin_country', label='Origin Country')
    ...
    class Meta:
        model = Product
        fields = ['price', 'name', 'vendor', 'origin_country', 'category', 'is_sustainable', 'sustainability_tags']
